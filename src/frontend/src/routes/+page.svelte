...
<section class="border-b border-base-content/15 py-12 md:py-14">
	...
	<div class="grid grid-cols-1 border-t border-l border-base-content/15 md:grid-cols-2">
		...
		>
			...
			<p class="font-display mb-1.5 text-base font-bold transition-colors group-hover:text-[#B85C38]">Договори</p>
			<p class="text-sm leading-relaxed text-base-content/55">Пълнотекстово търсене по заглавие, купувач, доставчик, година и стойност.</p>
		</a>
		...
		>
			...
			<p class="font-display mb-1.5 text-base font-bold transition-colors group-hover:text-[#B85C38]">Участници</p>
			<p class="text-sm leading-relaxed text-base-content/55">Профил на всеки купувач и доставчик — история, топ контрагенти и концентрация.</p>
		</a>
		...
		>
			...
			<p class="font-display mb-1.5 text-base font-bold transition-colors group-hover:text-[#B85C38]">Аномалии</p>
			<p class="text-sm leading-relaxed text-base-content/55">Автоматично засичане на прагове, поръчки без конкуренция и доминиращи доставчици.</p>
		</a>
		...
		>
			...
			<p class="font-display mb-1.5 text-base font-bold transition-colors group-hover:text-[#B85C38]">Карта</p>
			<p class="text-sm leading-relaxed text-base-content/55">Географска визуализация на купувачите — разходи и рисков индекс по градове.</p>
		</a>
...
<section class="border-b border-base-content/15 py-12 md:py-14">
	...
	<div class="grid grid-cols-1 gap-px bg-base-content/10 border border-base-content/10 rounded-sm overflow-hidden md:grid-cols-2">
